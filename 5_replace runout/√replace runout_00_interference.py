...
"""
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced1.csv", inp_data_1, delimiter=',')
...
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced3_1.csv", inp_data_33, delimiter=',')
