...
new_part1_flat_runout_up = new_part1_flat_node_data_up[:, 3]
part2_flat_runout_down = -pre.idata(ad_part2_runout, [4])
part2_flat_runout_spin_down = pre.spin(part2_flat_runout_down, 90)
...
part2_radial_runout_down = pre.idata(ad_part2_runout, [3])
part2_radial_runout_spin_down = pre.spin(part2_radial_runout_down, 90)
...
"""==============================================================predict=========================================================="""
clf_f = tree.DecisionTreeRegressor(criterion='mse', max_depth=30)
...
clf_r = tree.DecisionTreeRegressor(criterion='mse', max_depth=30)
...
#误差百分比
part1_dert_rox_percentage = (np.arctan(part1_normal_vector_raw_up[1] / part1_normal_vector_raw_up[3]) - np.arctan(part1_normal_vector_predict_up[1] / part1_normal_vector_predict_up[3])) / np.arctan(part1_normal_vector_raw_up[1] / part1_normal_vector_raw_up[3])
part1_dert_roy_percentage = (np.arctan(part1_normal_vector_raw_up[2] / part1_normal_vector_raw_up[3]) - np.arctan(part1_normal_vector_predict_up[2] / part1_normal_vector_predict_up[3])) / np.arctan(part1_normal_vector_raw_up[2] / part1_normal_vector_raw_up[3])
part2_dert_rox_percentage = (np.arctan(part2_normal_vector_raw_down[1] / part2_normal_vector_raw_down[3]) - np.arctan(part2_normal_vector_predict_down[1] / part2_normal_vector_predict_down[3])) / np.arctan(part2_normal_vector_raw_down[1] / part2_normal_vector_raw_down[3])
part2_dert_roy_percentage = (np.arctan(part2_normal_vector_raw_down[2] / part2_normal_vector_raw_down[3]) - np.arctan(part2_normal_vector_predict_down[2] / part2_normal_vector_predict_down[3])) / np.arctan(part2_normal_vector_raw_down[2] / part2_normal_vector_raw_down[3])
