...
part2_flat_runout_spin_down = pre.spin(part2_flat_runout_down, 240)
...
part2_flat_runout_spin_up = pre.spin(part2_flat_runout_up, 240)
...
part2_radial_runout_spin_down = pre.spin(part2_radial_runout_down, 240)
...
part2_radial_runout_spin_up = pre.spin(part2_radial_runout_up, 240)
...
"""
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(240)/Step5----replaced1.csv", inp_data_1, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(240)/Step5----replaced2.csv", inp_data_2, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(240)/Step5----replaced3.csv", inp_data_3, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(240)/Step5----replaced3_1.csv", inp_data_33, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(240)/Step5----replaced4.csv", inp_data_4, delimiter=',')
"""
