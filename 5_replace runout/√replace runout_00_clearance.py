...
new_part1_flat_node_data_down = rep.frure(80 / 2, part1_normal_vector_down[0], part1_normal_vector_down[1], part1_normal_vector_down[2], part1_normal_vector_down[3], part1_flat_runout_down, part1_flat_node_data_down, -H1)
...
new_part1_flat_node_data_up = rep.frure3(206.5 / 2, part1_normal_vector_up[0], part1_normal_vector_up[1], part1_normal_vector_up[2], part1_normal_vector_up[3], part1_flat_runout_up, part1_flat_node_data_up, 0)
...
new_part2_flat_node_data_down = rep.frure3(206.5 / 2, part2_normal_vector_down[0], part2_normal_vector_down[1], part2_normal_vector_down[2], part2_normal_vector_down[3], part2_flat_runout_down, part2_flat_node_data_down, 0)

part2_flat_runout_up = pre.idata(ad_part2_runout, [2])
part2_flat_runout_coordinate_up = pre.gcfl(80 / 2, part2_flat_runout_up, 0)
...
new_part2_flat_node_data_up = rep.frure(80 / 2, part2_normal_vector_up[0], part2_normal_vector_up[1], part2_normal_vector_up[2], part2_normal_vector_up[3], part2_flat_runout_up, part2_flat_node_data_up, H2)
...
part1_radial_runout_coordinate_down = pre.gcra(80 / 2, part1_radial_runout_down, 0)
...
new_part1_radial_node_data_down = rep.rrure2(part1_radial_runout_down, part1_radial_node_data_down)
...
new_part1_radial_node_data_up = rep.rrure2(part1_radial_runout_up, part1_radial_node_data_up)
...
new_part2_radial_node_data_down = rep.rrure2(part2_radial_runout_down, part2_radial_node_data_down)

part2_radial_runout_up = pre.idata(ad_part2_runout, [1])
part2_radial_runout_coordinate_up = pre.gcra(80 / 2, part2_radial_runout_up, 0)
...
new_part2_radial_node_data_up = rep.rrure2(part2_radial_runout_up, part2_radial_node_data_up)
...
penetration_r = pene_r(part1_radial_runout_up, part2_radial_runout_down)
...
interference = interf(part1_radial_runout_up, part2_radial_runout_down)  #max gap
...
# inp_data_2_1 = inp_data_2.copy()
# inp_data_2_1[:, 3] = inp_data_2_1[:, 3] + H1
# inp_data_3 = rep.ip2tr(inp_data_2, part2_node_number, -X, -Y, Z)
# inp_data_33 = rep.ip2tr(inp_data_1, part2_node_number, 0, 0, Z)
inp_data_333 = rep.ip2tr(inp_data_1, part2_node_number, 0, 0, Z)
...
# test = []
# for i in range(len(inp_data_2_1)):
#     if inp_data_2_1[i, 3] < 0:
#         test.append(inp_data_2_1[i, 3])
...
"""
np.savetxt("G:/20.1月份资料/20.1.10给一超师兄的仿真/Step5----replaced1(去斜面，仅微观跳动).csv", inp_data_1, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced2.csv", inp_data_2, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced2_1.csv", inp_data_2_1, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced3.csv", inp_data_3, delimiter=',')
np.savetxt("G:/20.1月份资料/20.1.10给一超师兄的仿真/Step5----replaced3_1.csv", inp_data_33, delimiter=',')
np.savetxt("G:/20.1月份资料/20.1.10给一超师兄的仿真/Step5----replaced3_2(去斜面，仅微观跳动).csv", inp_data_333, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced4.csv", inp_data_4, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(0)/Step5----replaced4_clearance.csv", inp_data_4, delimiter=',')
"""
...
#flat
ax = plt.figure().add_subplot(111, projection = '3d')
ax.scatter(new_part2_flat_node_data_up[:, 1], new_part2_flat_node_data_up[:, 2], new_part2_flat_node_data_up[:, 3], vmin = 0.0001, vmax = 0.0008, c = 'r', s = 0.5)
...
#scatter size adjustment:s = 0.5
ax = plt.figure().add_subplot(111, projection = '3d')
ax.scatter(inp_data_2_1[:, 1], inp_data_2_1[:, 2], inp_data_2_1[:, 3], c = 'r', s = 0.1)
