...
part2_flat_runout_spin_up = pre.spin(part2_flat_runout_up, 90)
...
part2_radial_runout_spin_up = pre.spin(part2_radial_runout_up, 90)
...
"""
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(90)/Step5----replaced1.csv", inp_data_1, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(90)/Step5----replaced2.csv", inp_data_2, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(90)/Step5----replaced3.csv", inp_data_3, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(90)/Step5----replaced3_1.csv", inp_data_33, delimiter=',')
np.savetxt("G:/19.12.25whole model (less grids)/Step5----replaced(90)/Step5----replaced4.csv", inp_data_4, delimiter=',')
"""
...
#flat
ax = plt.figure().add_subplot(111, projection = '3d')
ax.scatter(new_part2_flat_node_data_up[:, 1], new_part2_flat_node_data_up[:, 2], new_part2_flat_node_data_up[:, 3], c = 'r', s = 0.5)
...
plt.figure(3)
plt.scatter(n, part1_radial_runout_spin_up, s = 1)
plt.scatter(n, part2_radial_runout_spin_down, s = 1)
