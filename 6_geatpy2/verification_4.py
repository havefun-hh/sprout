# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 12:15:46 2020
...
def aimFunc3(args):  # 每次传入一行args
    ...
    aim = args[1]
    n = args[2]
    a = max(aim.bias_n_li(phase)[n - 1:,0])
...
if __name__ == '__main__':
    ...
    s = np.where(a.min() == a[:, :])  # s = [[22], [14]]
    print('最小目标值为：%s' % (a[s[0], s[1]]))   # a[s[0], s[1]] = 0.03121760107893163
