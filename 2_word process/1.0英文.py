...
for i in range(len(folderlist)):
    for j in range(2015, 2020, 1):
        read_files.append(glob.glob('D:/Anaconda files/word文件处理/computer science/' + folderlist[i] + '/' + str(j) + '/'+'*'+'.docx'))
...
# #保存
# df1.to_excel('英文100_spyder.xlsx', sheet_name='Sheet1')
# df1.to_csv('英文100_spyder.csv')
